const TreeData = {
    ...
    mapSites: [
        ...
        { id: "tanzania",    name: "Replanting the burnt Mkussu Forest", country: "Tanzania", type: "confirmed", source: "Tree-Nation", trees: 7057, lat: -4.798667, lng: 38.290218, description: "Planted by Oasis of Change (CORE) and Sustainable WWW (planting partner)." },
        { id: "tanzania-usambara", name: "Usambara Biodiversity Conservation", country: "Tanzania", type: "confirmed", source: "Tree-Nation", trees: 0, lat: -6.369028, lng: 34.888821, description: "Planted by Oasis of Change, Stanley Park Ecology Society, Sustainable WWW, and Mittler Senior Technology (planting partners)." },
        { id: "tanzania-geita", name: "Geita Tree Plantation for Community", country: "Tanzania", type: "confirmed", source: "Tree-Nation", trees: 0, lat: -2.874174, lng: 32.219807, description: "Planted by Sustainable WWW (planting partner)." },
        { id: "tanzania-plant-to-stop-poverty", name: "Plant to Stop Poverty", country: "Tanzania", type: "confirmed", source: "Tree-Nation", trees: 0, lat: -5.148192, lng: 38.448196, description: "Planted by Oasis of Change, Stanley Park Ecology Society, and Mittler Senior Technology (planting partners)." },
        { id: "tanzania-mlola", name: "Mlola Biodiversity Restoration", country: "Tanzania", type: "confirmed", source: "Tree-Nation", trees: 0, lat: -4.631748, lng: 38.426472, description: "Planted by Sustainable WWW (planting partner)." },
        ...
        { id: "kenya-bore",   name: "Bore",                          country: "Kenya", type: "confirmed", source: "Tree-Nation", trees: 0, lat: -3.0939, lng: 39.918999, description: "Planted by Oasis of Change and Sustainable WWW (planting partner)." },
        { id: "kenya-aberdare", name: "Save the Aberdare Forest",    country: "Kenya", type: "confirmed", source: "Tree-Nation", trees: 0, lat: -0.39104, lng: 36.730492, description: "Planted by Sustainable WWW (planting partner)." },
        { id: "kenya-swahili", name: "Swahili Coast Mangrove Restoration", country: "Kenya", type: "confirmed", source: "Tree-Nation", trees: 0, lat: -2.390773, lng: 40.782242, description: "Planted by Stanley Park Ecology Society and Sustainable WWW (planting partners)." },
        { id: "kenya",       name: "Kenya",        country: "Kenya",       type: "supported",  source: "Legacy Partner (Tero)",     trees: 0,    lat: -0.0236,  lng: 37.9062,  description: "" },
        { id: "uganda-forest-gardens", name: "Forest Gardens – Mount Elgon Region", country: "Uganda", type: "confirmed", source: "Tree-Nation", trees: 0, lat: 0.826785, lng: 34.38345, description: "Planted by Sustainable WWW and Mittler Senior Technology (planting partners)." },
        ...
        { id: "usa-montana",    name: "National Forest Recovery (Montana)", country: "United States", type: "confirmed", source: "Tree-Nation", trees: 0, lat: 46.89217,  lng: -114.340752, description: "Planted by Oasis of Change (historical planting)." },
        { id: "usa-california", name: "Lost Forests Recovery (California)", country: "United States", type: "confirmed", source: "Tree-Nation", trees: 0, lat: 41.490704, lng: -123.247726, description: "Planted by Sustainable WWW (planting partner project)." },
        { id: "india-tigers",  name: "Trees for Tigers", country: "India", type: "confirmed", source: "Tree-Nation", trees: 0, lat: 22.006382, lng: 86.039948, description: "Planted by Oasis of Change." },
        { id: "india-tribals", name: "Trees for Tribals", country: "India", type: "confirmed", source: "Tree-Nation", trees: 0, lat: 19.055958, lng: 81.986229, description: "Planted by Sustainable WWW (planting partner)." },
        ...
        { id: "cameroon",    name: "Cocoa Farmer Agroforestry", country: "Cameroon", type: "confirmed", source: "Tree-Nation", trees: 0, lat: 5.139279, lng: 10.275938, projectName: "Cocoa Farmer Agroforestry", description: "Planted by Oasis of Change (Tree-Nation)." },
