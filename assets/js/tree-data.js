const TreeData = {
    ...
    mapSites: [
        ...
        { id: "kenya-bore",   name: "Bore",                          country: "Kenya", type: "confirmed", source: "Tree-Nation", trees: 0, lat: 2.25, lng: 37.75, description: "Tree-Nation planting site." },
        { id: "kenya-aberdare", name: "Save the Aberdare Forest",    country: "Kenya", type: "confirmed", source: "Tree-Nation", trees: 0, lat: -0.4, lng: 36.75, description: "Planted by Trillion Trees in partnership with Nature Kenya and BirdLife International; Community Forest Associations carry out the planting." },
        { id: "kenya-swahili", name: "Swahili Coast Mangrove Restoration", country: "Kenya", type: "confirmed", source: "Tree-Nation", trees: 0, lat: -2.390773, lng: 40.782242, description: "Tree-Nation planting site." },
        { id: "kenya-forest-gardens", name: "Forest Gardens – Mount Elgon Region", country: "Kenya", type: "confirmed", source: "Tree-Nation", trees: 0, lat: 0.826785, lng: 34.38345, description: "Planted by Mittler Senior Technology and Sustainable WWW (planting partners)." },
        { id: "kenya-mt-elgon", name: "Preservation of Mt. Elgon Ecosystem", country: "Kenya", type: "confirmed", source: "Tree-Nation", trees: 0, lat: 1.272721, lng: 34.048634, description: "Planted by Sustainable WWW (planting partner)." },
