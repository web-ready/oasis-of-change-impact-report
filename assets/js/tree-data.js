const TreeData = {
    ...
    mapSites: [
        ...
        { id: "tanzania",    name: "Replanting the burnt Mkussu Forest", country: "Tanzania", type: "confirmed", source: "Tree-Nation", trees: 7057, lat: -4.798667, lng: 38.290218, projectName: "Replanting the burnt Mkussu Forest", description: "Planted by Oasis of Change (CORE) and Sustainable WWW (planting partner)." },
        ...
        { id: "nepal-refoorest", name: "Nepal - Refoorest",                  country: "Nepal", type: "supported", source: "Legacy Partner (Refoorest)", trees: 2000, lat: 28.3949, lng: 84.1240, description: "" },
        ...
        { id: "uganda-forest-gardens", name: "Forest Gardens – Mount Elgon Region", country: "Uganda", type: "confirmed", source: "Tree-Nation", trees: 0, lat: 0.826785, lng: 34.38345, description: "Planted by Stanley Park Ecology Society and Sustainable WWW (planting partners)." },
        { id: "uganda-mt-elgon", name: "Preservation of Mt. Elgon Ecosystem", country: "Uganda", type: "confirmed", source: "Tree-Nation", trees: 0, lat: 1.272721, lng: 34.048634, description: "Planted by Sustainable WWW and Mittler Senior Technology (planting partners)." },
