...
function downloadCertificate(certificateId) {
    if (typeof TreeData === 'undefined') {
        console.error('[Oasis of Change Certificates] TreeData not loaded');
        return;
    }
    ...
    if (certificate) {
        ...
        console.warn('[Oasis of Change Certificates] Certificate not found:', certificateId);
...
document.addEventListener('DOMContentLoaded', function() {
    if (typeof console !== 'undefined' && console.log) console.log('[Oasis of Change Certificates] Ready');
